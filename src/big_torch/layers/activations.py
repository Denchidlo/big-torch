...
class Sigmoid(AbstractLayer, DependecyCallMixin):
    output_names = ['y']
...
class ReLU(AbstractLayer, DependecyCallMixin):
    output_names = ['y']
...
class Tanh(AbstractLayer, DependecyCallMixin):
    output_names = ['y']
...
class Softmax(AbstractLayer, DependecyCallMixin):
    output_names = ['y']
