...
class OptimizatorFabric():
    def __init__(self, gen=RandomElementGenerator, updater=None, generator_kws={}, updater_kws={}, callbacks=[]) -> None:
    ...
    def train(self, model, x_train, y_train, x_val=None, y_val=None, eps=1e-5, max_iter=None, n_jobs=1):
        _eps = 10*eps
        ...
        while  True:
            ...
            optimizer.fit_transform(model, x_frame, y_frame, learning_information, n_jobs)
